...
//
// ```
// $ curl https://example.neophora.io -d '{"jsonrpc": "2.0","id": 1,"method": "GetAccountByAddressBlockHeightInJSON","params":{"Address":"AZCcft1uYtmZXxzHPr5tY7L6M85zG7Dsrv","BlockHeight":2400000} }'
