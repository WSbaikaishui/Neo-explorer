...
func (me *T) GetNEP5TransferAmountByContractHashSRCAddressDSTAddressTransactionHashTransferIndexInInteger(args struct {
	...
	if err := me.Data.GetArgsInBins(struct {
		...
		Keys:   []string{args.ContractHash.Val(), args.SRCAddress.H160(), args.DSTAddress.H160(), args.TransactionHash.Val(), args.TransferIndex.Hex()},
	}, &result); err != nil {
		return err
	}
