...
//
// ```
// $ curl https://example.neophora.io -d '{"jsonrpc": "2.0","id": 1,"method": "GetHeaderByBlockHashInJSON","params":{"BlockHash":"405b0dcc1704505feebd6f7a2121e3c979b949827bb1fa1eaf29a205086c156b"}}'
