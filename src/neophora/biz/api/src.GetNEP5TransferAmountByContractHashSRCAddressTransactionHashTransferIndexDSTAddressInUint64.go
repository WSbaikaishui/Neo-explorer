...
// GetNEP5TransferAmountByContractHashSRCAddressTransactionHashTransferIndexDSTAddressInUint64 ...
// as an example:
//
// ```
// TODO
// ```
func (me *T) GetNEP5TransferAmountByContractHashSRCAddressTransactionHashTransferIndexDSTAddressInUint64(args struct {
	ContractHash    h160.T
	SRCAddress      addr.T
