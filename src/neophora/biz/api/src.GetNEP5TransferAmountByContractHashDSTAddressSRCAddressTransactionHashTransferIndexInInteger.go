...
func (me *T) GetNEP5TransferAmountByContractHashDSTAddressSRCAddressTransactionHashTransferIndexInInteger(args struct {
	...
	if err := me.Data.GetArgsInBins(struct {
		...
		Keys:   []string{args.ContractHash.Val(), args.DSTAddress.H160(), args.SRCAddress.H160(), args.TransactionHash.Val(), args.TransferIndex.Hex()},
	}, &result); err != nil {
		return err
	}
