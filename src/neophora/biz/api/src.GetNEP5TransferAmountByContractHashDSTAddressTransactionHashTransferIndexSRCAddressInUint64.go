...
// TODO
// ```
func (me *T) GetNEP5TransferAmountByContractHashDSTAddressTransactionHashTransferIndexSRCAddressInUint64(args struct {
	ContractHash    h160.T
	DSTAddress      addr.T
	...
	if err := me.Data.GetArgsInBins(struct {
		...
		Keys:   []string{args.ContractHash.Val(), args.DSTAddress.H160(), args.TransactionHash.Val(), args.TransferIndex.Hex(), args.DSTAddress.H160()},
	}, &result); err != nil {
		return err
	}
