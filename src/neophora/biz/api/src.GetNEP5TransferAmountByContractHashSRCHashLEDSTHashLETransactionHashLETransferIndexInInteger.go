...
func (me *T) GetNEP5TransferAmountByContractHashSRCHashLEDSTHashLETransactionHashLETransferIndexInInteger(args struct {
	...
	if err := me.Data.GetArgsInBins(struct {
		...
		Keys:   []string{args.ContractHash.Val(), args.SRCHashLE.RevVal(), args.DSTHashLE.RevVal(), args.TransactionHashLE.RevVal(), args.TransferIndex.Hex()},
	}, &result); err != nil {
		return err
	}
