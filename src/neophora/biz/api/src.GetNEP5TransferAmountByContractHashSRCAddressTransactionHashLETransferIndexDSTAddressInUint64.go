...
// GetNEP5TransferAmountByContractHashSRCAddressTransactionHashLETransferIndexDSTAddressInUint64 ...
// as an example:
//
// ```
// TODO
// ```
func (me *T) GetNEP5TransferAmountByContractHashSRCAddressTransactionHashLETransferIndexDSTAddressInUint64(args struct {
	ContractHash      h160.T
	SRCAddress        addr.T
