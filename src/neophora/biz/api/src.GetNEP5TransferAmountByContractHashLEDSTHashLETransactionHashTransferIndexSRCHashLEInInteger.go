...
func (me *T) GetNEP5TransferAmountByContractHashLEDSTHashLETransactionHashTransferIndexSRCHashLEInInteger(args struct {
	...
	if err := me.Data.GetArgsInBins(struct {
		...
		Keys:   []string{args.ContractHashLE.RevVal(), args.DSTHashLE.RevVal(), args.TransactionHash.Val(), args.TransferIndex.Hex(), args.SRCHashLE.RevVal()},
	}, &result); err != nil {
		return err
	}
