...
// GetApplicationLogByTransactionHashLEBlockHeightInJSON ...
// as an example:
//
// ```
// $ curl https://example.neophora.io -d '{"jsonrpc": "2.0","id": 1,"method": "GetApplicationLogByTransactionHashLEInJSON","params":{"TransactionHashLE":"0b87eb23601dc14453a6d986908b72d607f0abfeb68f6603045e877ac9db9b76"}}'
...
func (me *T) GetApplicationLogByTransactionHashLEInJSON(args struct {
