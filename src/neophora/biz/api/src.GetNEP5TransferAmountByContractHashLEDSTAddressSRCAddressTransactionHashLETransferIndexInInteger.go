...
// GetNEP5TransferAmountByContractHashLEDSTAddressSRCAddressTransactionHashLETransferIndexInInteger ...
// as an example:
//
// ```
// $ curl https://example.neophora.io -d '{"jsonrpc": "2.0","id": 1,"method": "GetNEP5TransferAmountByContractHashLEDSTAddressSRCAddressTransactionHashLETransferIndexInInteger","params":{"ContractHashLE":"e8f98440ad0d7a6e76d84fb1c3d3f8a16e162e97","DSTAddress":"AZcuN1PmBJmSdt8ubY6JqDBGCrHVDpo4kR","SRCAddress":"Aa1hdLWLw441vQ94hzpwDj8FY7QEh1zsr6","TransactionHashLE":"9edfff14e7ac6d3c0bda2976de78fa774a119124cec7343dd66dad5cf4ffeddf","TransferIndex":0}}'
// {"id":1,"result":1650000000000,"error":null}
// ```
func (me *T) GetNEP5TransferAmountByContractHashLEDSTAddressSRCAddressTransactionHashLETransferIndexInInteger(args struct {
