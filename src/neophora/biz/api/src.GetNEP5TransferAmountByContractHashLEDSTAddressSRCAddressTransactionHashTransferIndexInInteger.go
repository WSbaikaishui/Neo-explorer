...
// GetNEP5TransferAmountByContractHashLEDSTAddressSRCAddressTransactionHashTransferIndexInInteger ...
// as an example:
//
// ```
// $ curl https://example.neophora.io -d '{"jsonrpc": "2.0","id": 1,"method": "GetNEP5TransferAmountByContractHashLEDSTAddressSRCAddressTransactionHashTransferIndexInInteger","params":{"ContractHashLE":"e8f98440ad0d7a6e76d84fb1c3d3f8a16e162e97","DSTAddress":"AZcuN1PmBJmSdt8ubY6JqDBGCrHVDpo4kR","SRCAddress":"Aa1hdLWLw441vQ94hzpwDj8FY7QEh1zsr6","TransactionHash":"dfedfff45cad6dd63d34c7ce2491114a77fa78de7629da0b3c6dace714ffdf9e","TransferIndex":0}}'
// {"id":1,"result":1650000000000,"error":null}
// ```
func (me *T) GetNEP5TransferAmountByContractHashLEDSTAddressSRCAddressTransactionHashTransferIndexInInteger(args struct {
	...
	if err := me.Data.GetArgsInBins(struct {
		...
		Keys:   []string{args.ContractHashLE.RevVal(), args.DSTAddress.H160(), args.SRCAddress.H160(), args.TransactionHash.Val(), args.TransferIndex.Hex()},
	}, &result); err != nil {
		return err
	}
