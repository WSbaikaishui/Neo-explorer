...
// GetNEP5TransferAmountByContractHashDSTAddressSRCAddressTransactionHashLETransferIndexInUint64 ...
// as an example:
//
// ```
// TODO
// ```
func (me *T) GetNEP5TransferAmountByContractHashDSTAddressSRCAddressTransactionHashLETransferIndexInUint64(args struct {
	ContractHash      h160.T
	DSTAddress        addr.T
	SRCAddress        addr.T
